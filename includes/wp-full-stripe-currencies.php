...
class MM_WPFS_Currencies {
	 ...
	 * @return string|void
	 */
	public static function formatAndEscape( $currency, $amount, $decimalsForInteger = true, $showCurrency = true ) {
		$decimalSeparatorSymbol                = self::getGlobalDecimalSeparatorSymbolOption();
		$showCurrencySymbolInsteadOfCode       = self::getGlobalShowCurrencySymbolInsteadOfCode();
		$showCurrencySignAtFirstPosition       = self::getGlobalShowCurrencySignAtFirstPosition();
		$putWhitespaceBetweenCurrencyAndAmount = self::getGlobalPutWhitespaceBetweenCurrencyAndAmount();
	 ...
	 * @return string
	 */
	public static function getGlobalDecimalSeparatorSymbolOption() {
		$options = get_option( 'fullstripe_options' );
		if ( is_array( $options ) && array_key_exists( MM_WPFS::OPTION_DECIMAL_SEPARATOR_SYMBOL, $options ) ) {
			$decimalSeparatorSymbol = $options[ MM_WPFS::OPTION_DECIMAL_SEPARATOR_SYMBOL ];
	 ...
	 * @return bool
	 */
	public static function getGlobalShowCurrencySymbolInsteadOfCode() {
		$options = get_option( 'fullstripe_options' );
		if ( is_array( $options ) && array_key_exists( MM_WPFS::OPTION_SHOW_CURRENCY_SYMBOL_INSTEAD_OF_CODE, $options ) ) {
			$showCurrencySymbolInsteadOfCode = $options[ MM_WPFS::OPTION_SHOW_CURRENCY_SYMBOL_INSTEAD_OF_CODE ];
	 ...
	 * @return bool
	 */
	public static function getGlobalShowCurrencySignAtFirstPosition() {
		$options = get_option( 'fullstripe_options' );
		if ( is_array( $options ) && array_key_exists( MM_WPFS::OPTION_SHOW_CURRENCY_SIGN_AT_FIRST_POSITION, $options ) ) {
			$showCurrencySignFirst = $options[ MM_WPFS::OPTION_SHOW_CURRENCY_SIGN_AT_FIRST_POSITION ];
	 ...
	 * @return bool
	 */
	public static function getGlobalPutWhitespaceBetweenCurrencyAndAmount() {
		$options = get_option( 'fullstripe_options' );
		if ( is_array( $options ) && array_key_exists( MM_WPFS::OPTION_PUT_WHITESPACE_BETWEEN_CURRENCY_AND_AMOUNT, $options ) ) {
			$putWhitespaceBetweenCurrencyAndAmount = $options[ MM_WPFS::OPTION_PUT_WHITESPACE_BETWEEN_CURRENCY_AND_AMOUNT ];
	...
	/**
	 * Returns the selected decimal separator symbol according to WPFS options or the default value if not set.
	 * @see MM_WPFS_CurrencyFormat::DECIMAL_SEPARATOR_COMMA
	 * @see MM_WPFS_CurrencyFormat::DECIMAL_SEPARATOR_DOT
	 * @return string
	 */
	public static function getGlobalDecimalSeparatorSymbol() {
		$options = get_option( 'fullstripe_options' );
		if ( is_array( $options ) && array_key_exists( MM_WPFS::OPTION_DECIMAL_SEPARATOR_SYMBOL, $options ) ) {
			$decimalSeparatorSymbol = $options[ MM_WPFS::OPTION_DECIMAL_SEPARATOR_SYMBOL ];
			if ( MM_WPFS::DECIMAL_SEPARATOR_SYMBOL_COMMA == $decimalSeparatorSymbol ) {
				return MM_WPFS_CurrencyFormat::DECIMAL_SEPARATOR_COMMA;
			}
		}

		return MM_WPFS_CurrencyFormat::DECIMAL_SEPARATOR_DOT;
	}
     ...
     * @return string|void
     */
    public static function formatAndEscapeByAdmin( $currency, $amount, $decimalsForInteger = true, $showCurrency = true ) {
     ...
     * @throws Exception
     */
    protected static function createCurrencyFormatByAdmin( $currency ) {
        $options = get_option( 'fullstripe_options' );

        $currencyFormat = self::createCurrencyFormat(
            $currency,
            $options[ MM_WPFS::OPTION_DECIMAL_SEPARATOR_SYMBOL ],
            1 == $options[ MM_WPFS::OPTION_SHOW_CURRENCY_SYMBOL_INSTEAD_OF_CODE ] ? true : false,
            1 == $options[ MM_WPFS::OPTION_SHOW_CURRENCY_SIGN_AT_FIRST_POSITION ] ? true : false,
            1 == $options[ MM_WPFS::OPTION_PUT_WHITESPACE_BETWEEN_CURRENCY_AND_AMOUNT ] ? true : false
        );
	 ...
	 * @throws Exception
	 */
	public static function format( $currency, $amount, $decimalsForInteger = true, $showCurrency = true ) {
		$decimalSeparatorSymbol                = self::getGlobalDecimalSeparatorSymbolOption();
		$showCurrencySymbolInsteadOfCode       = self::getGlobalShowCurrencySymbolInsteadOfCode();
		$showCurrencySignAtFirstPosition       = self::getGlobalShowCurrencySignAtFirstPosition();
		$putWhitespaceBetweenCurrencyAndAmount = self::getGlobalPutWhitespaceBetweenCurrencyAndAmount();
