...
<div class="changelog">
	<div class="feature-section images-stagger-right">
		...
		<div class="changelog-updates">
            <strong>Jul 21, 2021 (v5.5.6)</strong>
            <blockquote>
                <p>Changed:</p>
                <ul>
                    <li>Fixed: An internal error appeared on checkout save card forms.</li>
                    <li>Fixed: The "Manage subscriptions" page now works also on cached pages.</li>
                    <li>Fixed: Checkout subscription forms display the plan name instead of plan id on invoice items of the setup fee.</li>
                    <li>Fixed: Database tables now have primary keys recognized also by MySql 7.8+.</li>
                </ul>
            </blockquote>
